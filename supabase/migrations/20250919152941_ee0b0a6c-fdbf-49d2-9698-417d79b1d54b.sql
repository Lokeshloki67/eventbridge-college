-- Remove foreign key constraint from profiles table to allow demo users
...
-- Insert sample profiles with demo UIDs
INSERT INTO public.profiles (user_id, full_name, email, role, d_no, phone_no) VALUES
('admin-demo-uid-001', 'Dr. Sarah Johnson', 'admin@college.edu', 'admin', 'A001', '+1-555-0101'),
('staff-demo-uid-001', 'Prof. Michael Chen', 'michael.chen@college.edu', 'staff', 'S101', '+1-555-0201'),
('staff-demo-uid-002', 'Dr. Emily Rodriguez', 'emily.rodriguez@college.edu', 'staff', 'S102', '+1-555-0202'),
('staff-demo-uid-003', 'Prof. David Kim', 'david.kim@college.edu', 'staff', 'S103', '+1-555-0203'),
('student-demo-uid-001', 'Alex Thompson', 'alex.thompson@student.edu', 'student', 'ST2024001', '+1-555-0301'),
('student-demo-uid-002', 'Jessica Liu', 'jessica.liu@student.edu', 'student', 'ST2024002', '+1-555-0302'),
('student-demo-uid-003', 'Ryan Patel', 'ryan.patel@student.edu', 'student', 'ST2024003', '+1-555-0303'),
('student-demo-uid-004', 'Maria Garcia', 'maria.garcia@student.edu', 'student', 'ST2024004', '+1-555-0304'),
('student-demo-uid-005', 'James Wilson', 'james.wilson@student.edu', 'student', 'ST2024005', '+1-555-0305');
...
BEGIN
    ...
    -- Insert staff assignments if IDs found
    IF admin_id IS NOT NULL AND tech_event_id IS NOT NULL AND michael_id IS NOT NULL THEN
